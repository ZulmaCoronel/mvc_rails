...
class OrdensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orden" do
    assert_difference('Orden.count') do
      post ordens_url, params: { orden: { fecha: @orden.fecha, numero_orden: @orden.numero_orden } }
    end
  ...
  test "should update orden" do
    patch orden_url(@orden), params: { orden: { fecha: @orden.fecha, numero_orden: @orden.numero_orden } }
